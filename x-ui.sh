...
install() {
    bash <(curl -Ls https://raw.githubusercontent.com/jbhd135/3x-ui-jbhd/main/install.sh)
    if [[ $? == 0 ]]; then
        if [[ $# == 0 ]]; then
            start
        else
...
update() {
    ...
    bash <(curl -Ls https://raw.githubusercontent.com/jbhd135/3x-ui-jbhd/main/update.sh)
    if [[ $? == 0 ]]; then
...
update_menu() {
    ...
    curl -fLRo /usr/bin/x-ui https://raw.githubusercontent.com/jbhd135/3x-ui-jbhd/main/x-ui.sh
...
legacy_version() {
    ...
    install_command="bash <(curl -Ls "https://raw.githubusercontent.com/jbhd135/3x-ui-jbhd/v$tag_version/install.sh") v$tag_version"
...
uninstall() {
    ...
    echo -e "${green}bash <(curl -fsSL https://raw.githubusercontent.com/jbhd135/3x-ui-jbhd/main/scripts/install-selfhosted.sh)${plain}"
    echo ""
...
update_shell() {
    curl -fLRo /usr/bin/x-ui -z /usr/bin/x-ui https://github.com/jbhd135/3x-ui-jbhd/raw/main/x-ui.sh
    if [[ $? != 0 ]]; then
        echo ""
